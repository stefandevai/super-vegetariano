...
(function(){
  ...
  function initMap() {
    ...
    popups['mariano'].bindPopup("<h3>Super Vegetariano - Mariano</h3><div><img src='assets/images/mariano.jpg'><div><a href='https://goo.gl/maps/KWoWyg3kha32' target='_blank'>Ver en Google Maps</a>");
    popups['valentin'].bindPopup("<h3>Super Vegetariano - Santa María</h3><div><img src='assets/images/stma.jpg'><div><a href='https://goo.gl/maps/bq8tcUtAcyC2' target='_blank'>Ver en Google Maps</a>");
  }
